...
class AddressfactureController extends Controller
{
    /**
    ...
    {
        Addressfacture::create($request->all());
        return back();
    }
    ...
    {
        $addressfacture=Addressfacture::findOrFail($id);
        ...
        $addressfacture->user_id=$request->user_id;
        $addressfacture->save();
        return back();
    }
